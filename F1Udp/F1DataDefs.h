...
{
   // Valid event strings
   inline static const char* cs_sessionStartedEventCode = "SSTA";
   inline static const char* cs_sessionEndedEventCode = "SEND";
   inline static const char* cs_fastestLapEventCode = "FTLP";
   inline static const char* cs_retirementEventCode = "RTMT";
   inline static const char* cs_drsEnabledEventCode = "DRSE";
   inline static const char* cs_drsDisabledEventCode = "DRSD";
   inline static const char* cs_teamMateInPitsEventCode = "TMPT";
   inline static const char* cs_chequeredFlagEventCode = "CHQF";
   inline static const char* cs_raceWinnerEventCode = "RCWN";
   inline static const char* cs_penaltyEventCode = "PENA";
   inline static const char* cs_speedTrapEventCode = "SPTP";
   inline static const char* cs_startLightsEventCode = "STLG";
   inline static const char* cs_lightsOutEventCode = "LGOT";
   inline static const char* cs_driveThroughServedEventCode = "DTSV";
   inline static const char* cs_stopGoServedEventCode = "SGSV";
   inline static const char* cs_flashbackEventCode = "FLBK";
   inline static const char* cs_buttonStatusEventCode = "BUTN";
   inline static const char* cs_redFlagEventCode = "RDFL";
   inline static const char* cs_overtakeEventCode = "OVTK";
   inline static const char* cs_safetyCarEventCode = "SCAR";
   inline static const char* cs_collisionEventCode = "COLL";
...
static_assert(sizeof(PacketEventData) == 45);
...
static_assert(sizeof(PacketSessionHistoryData) == 1460);
...
static_assert(sizeof(PacketTyreSetsData) == 231);
...
static_assert(sizeof(PacketMotionExData) == 273);
